...
public class RconModule_Constant {
    ...
    public static final DialogInterface.OnClickListener BLANK_DIALOG_CLICK_LISTENER = (di, w) -> {
    };
    public static final String IPV4_PATTERN = "^(25[0-5]|2[0-4][0-9]|[01]?[0-9]{1,2})(\\.(25[0-5]|2[0-4][0-9]|[01]?[0-9]{1,2})){3}$";
