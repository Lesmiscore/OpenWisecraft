...
public class MainActivity extends MainActivityBase1
{
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		add.add(Menu.NONE,1,1,R.string.addSingle).setIcon(TheApplication.instance.getTintedDrawable(drawable.ic_add_black_48dp         ,getResources().getColor(R.color.light_icons_foreground)));
		add.add(Menu.NONE,2,1,R.string.imporT).setIcon(TheApplication.instance.getTintedDrawable(drawable.ic_file_download_black_48dp  ,getResources().getColor(R.color.light_icons_foreground)));
		add.add(Menu.NONE,3,1,R.string.export).setIcon(TheApplication.instance.getTintedDrawable(drawable.ic_file_upload_black_48dp    ,getResources().getColor(R.color.light_icons_foreground)));
		...
		misc.add(Menu.NONE,5,1,R.string.aboutApp).setIcon(TheApplication.instance.getTintedDrawable(drawable.ic_info_outline_black_48dp,getResources().getColor(R.color.light_icons_foreground)));
