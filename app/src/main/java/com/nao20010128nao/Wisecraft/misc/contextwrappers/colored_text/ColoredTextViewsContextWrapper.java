...
public class ColoredTextViewsContextWrapper extends ContextWrapper
{
	...
	public Object getSystemService(String name) {
		...
		if(LAYOUT_INFLATER_SERVICE.equals(name)){
			return new InternalLayoutInflater(this,0);
		}
	...
	class InternalLayoutInflater extends LayoutInflater{
		...
		protected InternalLayoutInflater(Context context, int attributeId) {
			super(context);
			mAttributeId = attributeId;
			setUpLayoutFactories(false);
		}

		protected InternalLayoutInflater(LayoutInflater original, Context newContext, int attributeId, final boolean cloned) {
		...
		public LayoutInflater cloneInContext(Context newContext) {
			return new InternalLayoutInflater(this, newContext, mAttributeId, true);
		}
...
//            LayoutInflaterCompat.setFactory(this, new WrapperFactory2(factory2, mCalligraphyFactory));
		...
		private class WrapperFactory implements Factory {
			...
			public WrapperFactory(Factory factory, InternalLayoutInflater inflater, CalligraphyFactory calligraphyFactory) {
				mFactory = factory;
				mInflater = inflater;
		 ...
		 */
		private class PrivateWrapperFactory2 extends WrapperFactory2 {

			private final InternalLayoutInflater mInflater;

			public PrivateWrapperFactory2(Factory2 factory2, InternalLayoutInflater inflater, CalligraphyFactory calligraphyFactory) {
